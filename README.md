...
1. **Clone the Repository**:  
   ...
   ```
2. **Add to Your Project**: Copy `HImGuiImageManager.h` (and `.cpp` if provided) into your codebase.  
3. **Link Dependencies**: Ensure ImGui and your graphics API (e.g., OpenGL, DirectX) are linked.  
4. **Compile**: Build the library with your project.
...
- **`HIMAGE_MANAGER_URL_IMAGE_ENABLED`**  
  ...
  - **Dependencies**: Requires [cpp-httplib](https://github.com/yhirose/cpp-httplib).  
    - **Download**: Get the latest version from [cpp-httplib GitHub](https://github.com/yhirose/cpp-httplib).  
...
- **`HIMAGE_MANAGER_URL_OPENSSL_SUPPORT`**  
  ...
  - **Dependencies**: Requires [OpenSSL](https://github.com/openssl/openssl) version 3.0 or later.  
    - **Download**: Obtain the source from [OpenSSL GitHub](https://github.com/openssl/openssl).  
    - **Build**: Follow the [OpenSSL installation guide](https://github.com/openssl/openssl/blob/master/INSTALL.md).  
    - **Tutorial**: If you encounter issues, watch [this YouTube tutorial](https://youtu.be/PMHEoBkxYaQ?si=fYpChXxw_uEitGMT) for detailed OpenSSL setup instructions.
...
HImGuiImageManager is released under the [MIT License](LICENSE). Feel free to use, modify, and distribute.

---

## 📧 Contact & Support

- **GitHub**: Submit issues to [HImGuiImageManager Issues](https://github.com/Half-People/HImGuiImageManager/issues).  
